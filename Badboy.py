...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.comTermuxmasterAley.com')
    else:
...
def login():
    os.system('clear')
    print logo1
    print "\033[1;91m[1]\x1b[1;97mSTART WITH ALEY( \033[1;92m NOW)"
    time.sleep(0.05)
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;97m[1]  START CLONING With ALEY'
    time.sleep(0.10)
    print '\x1b[1;92m[2] ALEY FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6] ALEY FACEBOOK'
    time.sleep(0.10)
...
\033[1;95myoutube\033[1;97mhttps://w ww.youtube.com/channel/aleystarboy"""
